...
const thoughts = [
  {
    negative: "I always fail at everything.",
    positive: "I can learn from mistakes and improve.",
  },
  {
    negative: "Nobody likes me.",
    positive: "I have people who care about me.",
  },
  {
    negative: "I am not good enough.",
    positive: "I have strengths that make me valuable.",
  },
  {
    negative: "I will never be happy.",
    positive: "Happiness comes in moments, and I can create more.",
  },
  {
    negative: "I’m too weak to handle this.",
    positive: "I have overcome challenges before.",
  },
  {
    negative: "Everything is hopeless.",
    positive: "Things can improve with time and effort.",
  },
  {
    negative: "I don’t deserve good things.",
    positive: "I am just as deserving of happiness as anyone else.",
  },
  {
    negative: "People will leave me if I make mistakes.",
    positive: "True friends accept me even with mistakes.",
  },
  {
    negative: "I have no control over my life.",
    positive: "I can control my actions and decisions.",
  },
  {
    negative: "If I fail, everyone will judge me.",
    positive: "Failure is a step toward learning and growth.",
  },
  {
    negative: "I’ll never achieve my goals.",
    positive: "With persistence and effort, I can succeed.",
  },
  {
    negative: "I am not smart enough.",
    positive: "I am capable of learning and growing.",
  },
  { negative: "I’m unlovable.", positive: "I am worthy of love and respect." },
  {
    negative: "Nothing ever works out for me.",
    positive: "Setbacks are part of progress, and I can try again.",
  },
];
  ...
  const handleChoice = (selectedOption) => {
    ...
    setTimeout(() => {
      if (currentIndex < 7) {
        ...
        Alert.alert(
          "Great Job!",
          `You scored ${score + (selectedOption === correctAnswer ? 1 : 0)}/8!`
        );
      }
    }, 1000);
  };
  ...
  return (
    ...
    >
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.gameTitle}>CBT Lingo</Text>
        <Text style={styles.gameDescription}>
          Train your mind to recognize and replace negative thoughts with
          positive ones.
        </Text>
      </View>
      <View style={styles.container}>
        ...
        {currentIndex < 8 ? (
          <>
            <Text style={styles.negativeThought}>
              {gameThoughts[currentIndex]?.negative}
            </Text>
            <View style={styles.gridContainer}>
              {options.map((option, index) => (
                <TouchableOpacity
